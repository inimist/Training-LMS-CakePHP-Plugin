...
<p >Your enrolled to the course ' <?php echo $this->Html->link($enrollment['Course']['name'], array('full_base' => true, 'plugin'=>'training', 'controller'=>'courses', 'action' => 'view', $enrollment['Course']['id'], 'admin'=>false)); ?> </p>
